...
;(function (exports) {
    ...
    var ParseOrBackbone = require("backbone"); // change to "backbone" if not using Parse
    var _ = require("lodash");
    var $ = require("jquery");
    var TemplateView = ParseOrBackbone.View.extend({
        cache: {},
        stream: function stream(url) {
            var x = $.Deferred();
            if (this.cache[url]) {
...
;(function (exports) {
    ...
    Backbone.MenusView = MyViewConstructor.TemplateView.extend({
        ...
        showDropList: function showDropList(evt) {
            var $dropDownList = $(".dd-list");
            $dropDownList.toggle();
        },

        showMegaMenu: function showMegaMenu(evt) {
